  ...
  render() {
    ...
    return (
      ...
      <div className = "select">
        <Button style = {{marginRight:10+"px",background:"red"}} type="primary">
         删除
        </Button>
   ...
   {/*   老师添加 */}
    <div className = "addForm" ref="addform">
        <div className = "cancleBox">
          <Button type="primary" style = {{background:"red"}} onClick = {this.addFormNone.bind(this)}>取消</Button>
        </div>
         
        <div className = "teacher-name flex">
          <span>请输入您的姓名：</span>
        <Input className = "input-name" ref="nameInput" placeholder="请输入姓名" width={300} />
        </div>

        <div className = "teacher-name flex">
          <span>请输入您的介绍：</span>
        <Input className = "input-name" ref="introduceInput" placeholder="请输入介绍" width={300} />
        </div>

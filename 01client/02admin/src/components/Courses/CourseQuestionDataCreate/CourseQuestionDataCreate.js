...
import "./CourseQuestionDataCreate.css";
import { Icon, Button, Input, Select } from "antd";
import net from "../../../utils/net";
import E from "wangeditor";
import { Link } from "react-router-dom";
export default class CourseQuestionData extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editorContent: ""
    ...
    return (
      <div className="courseTestBox">
        <div className="testHeader">
          <h1 className="testTitle">创建试卷2</h1>
        </div>
